...
export default function TermsPage() {
  return <article className="mx-auto max-w-3xl space-y-6 bg-[#f6f4ee] px-6 py-12 text-sm leading-7 [font-family:Arial,Helvetica,sans-serif] dark:bg-[#191918]">
    ...
    <p>Each repository has its own license, contribution rules and maintainers. A listing or announcement does not grant rights to external code or imply that a project endorses maintain.help.</p>
