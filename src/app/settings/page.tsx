...
export default async function SettingsPage() {
  ...
  return (
    <div className="page-shell">
      ...
      <header className="page-intro mt-8 block">
      ...
      <div className="mt-8 grid gap-8 md:grid-cols-[180px_minmax(0,1fr)] lg:gap-14">
        <nav aria-label="Settings sections" className="flex flex-wrap gap-1 self-start text-sm md:sticky md:top-28 md:flex-col">
        ...
        <div className="min-w-0 space-y-8">
          <section id="profile" aria-labelledby="profile-heading" className="form-panel scroll-mt-28">
          ...
          <section id="connection" aria-labelledby="connection-heading" className="form-panel scroll-mt-28">
          ...
          <section id="account" aria-labelledby="account-heading" className="scroll-mt-28 space-y-5">
            <div className="flex flex-wrap items-center justify-between gap-4 rounded-2xl border border-border bg-card p-6 md:p-8">
