...
export function ClaimBanner({
  ...
  if (activeRequest) {
    return (
      <Card className="rounded-xl flex flex-col gap-2 border-emerald-200 bg-emerald-50/60 p-4 dark:border-emerald-900 dark:bg-emerald-950/40">
  ...
  return (
    <Card className="rounded-xl flex flex-col items-start gap-3 bg-card p-5">
